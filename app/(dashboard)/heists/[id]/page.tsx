...
import styles from "@/components/HeistDetailCard/HeistDetailCard.module.css"

export default function HeistDetailsPage() {
  const { id } = useParams<{ id: string }>()
  const { heist, isLoading, error, notFound } = useHeist(id)
  ...
  return (
    <div className="page-content">
      ...
      {isLoading ? (
        ...
        heist && <HeistDetailCard heist={heist} />
      )}
    </div>
  )
}
